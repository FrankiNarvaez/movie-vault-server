...
func FetchDiscoverMovies(includeAdult, includeVideo bool, language, page, sortBy, withCompanies, withGenres string) (*types.DiscorverMoviesResults, error) {
	var movies types.DiscorverMoviesResults
...
func FetchDiscoverSeries(includeAdult, includeNullFirstAirDates bool, language, page, sortBy, withCompanies, withGenres, withNetworks string) (*types.DiscorverSeriesResults, error) {
	var series types.DiscorverSeriesResults
